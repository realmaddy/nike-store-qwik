...
<section class="max-w-7xl mx-auto py-20 px-6 md:px-10">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
    {[
      ...
      {/* 📬 NEWSLETTER - PRO EDITION */}
<section class="relative overflow-hidden bg-[#0a0a0a] text-white py-28 text-center">
  {/* إضاءة خلفية subtle */}
  <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.06)_0%,transparent_70%)]"></div>

  <div class="relative z-10 max-w-3xl mx-auto px-6">
    <h2 class="text-5xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight">
    ...
    <form class="flex flex-col sm:flex-row justify-center items-center gap-4">
      <input
        ...
        class="w-full sm:w-96 px-6 py-3 rounded-full text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-600 transition-all"
        required
      />
      <button
        type="submit"
        class="bg-white text-black font-semibold px-8 py-3 rounded-full hover:bg-gray-200 transition-all shadow-lg active:scale-95"
      >
        Join Now
      </button>
    </form>
  ...
  {/* تزيين جانبي subtle */}
  <div class="absolute -left-40 top-0 w-[400px] h-[400px] bg-red-600/20 rounded-full blur-3xl"></div>
  <div class="absolute -right-40 bottom-0 w-[400px] h-[400px] bg-gray-700/30 rounded-full blur-3xl"></div>
</section>
